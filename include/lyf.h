...
namespace lyf {
	...
	namespace PrintTool {
        ...
        inline string blue(const string& str) { return "\033[34m" + str + "\033[0m"; }
		inline string green(const string& str) { return "\033[32m" + str + "\033[0m"; }
		inline string red(const string& str) { return "\033[31m" + str + "\033[0m"; }
