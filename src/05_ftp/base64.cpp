...
std::string
base64_encode(const unsigned char* bytes_to_encode, size_t in_len, bool url) {
...
template<typename String>
static std::string
decode(const String& encoded_string, bool remove_linebreaks) {
    //
...
std::string
base64_decode(const std::string& s, bool remove_linebreaks) {
    return decode(s, remove_linebreaks);
}

std::string
base64_encode(const std::string& s, bool url) {
    return encode(s, url);
}

std::string
base64_encode_pem(const std::string& s) {
    return encode_pem(s);
}

std::string
base64_encode_mime(const std::string& s) {
